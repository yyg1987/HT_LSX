...
using LY.PF.Authorization.Permissions;
using LY.PF.Authorization.Permissions.Dto;
using LY.PF.Authorization.Roles.Dto;

namespace LY.PF.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : PFAppServiceBase, IRoleAppService
    {
