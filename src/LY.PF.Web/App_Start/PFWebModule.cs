...
using LY.PF.Web.App.Startup;//SPA!
using LY.PF.Web.Areas.Mpa.Startup;//MPA!
using LY.PF.Web.Bundling;
using LY.PF.Web.Navigation;
using LY.PF.Web.Routing;
using LY.PF.WebApi;
...
namespace LY.PF.Web
{
    ...
    public class PFWebModule : AbpModule
    {
