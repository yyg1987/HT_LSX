...
using LY.PF.Sessions;
using LY.PF.Web.Areas.Mpa.Models.Layout;
using LY.PF.Web.Areas.Mpa.Startup;
using LY.PF.Web.Controllers;
using LY.PF.Web.Models.Layout;
using LY.PF.Web.Session;
using HeaderViewModel = LY.PF.Web.Areas.Mpa.Models.Layout.HeaderViewModel;

namespace LY.PF.Web.Areas.Mpa.Controllers
{
    [AbpMvcAuthorize]
    public class LayoutController : PFControllerBase
    {
