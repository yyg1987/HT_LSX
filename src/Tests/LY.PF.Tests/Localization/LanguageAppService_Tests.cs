...
using LY.PF.Localization;
using LY.PF.Localization.Dto;
using LY.PF.Migrations.Seed.Host;
using Shouldly;
using Xunit;

namespace LY.PF.Tests.Localization
{
    public class LanguageAppService_Tests : AppTestBase
    {
        ...
        public async Task UpdateLanguageText()
        {
            await _languageAppService.UpdateLanguageText(
                ...
                {
                    SourceName = PFConsts.LocalizationSourceName,
                    LanguageName = "en",
                    Key = "Save",
            ...
            var newValue = Resolve<ILocalizationManager>()
                .GetString(
                    PFConsts.LocalizationSourceName,
                    "Save",
